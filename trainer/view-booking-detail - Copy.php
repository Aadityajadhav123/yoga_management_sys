...
<head>
  ...
  <title>Yoga Classes Registration System | View Booking Detail</title>
    ...
    foreach ($results as $row) { ?>
                  ...
                  <table border="1"
                    ...
                    <tr>
                      ...
                      <th>Yoga Image</th>
                      <td><img src="images/<?php echo $row->YogaImages; ?>" width="100" height="100"
                          value="<?php echo $row->YogaImages; ?>"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <th>Days and Time</th>
                      <td>
                        <?php echo $row->DaysTime; ?>
                      </td>

                      <th>Yoga Trainer</th>
                      <td>
                        <?php echo $row->YogaTrainer; ?>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php echo $row->TrainerContactnumber; ?>
                      </td>
                      <th>Fees</th>
                      <td>
                        <?php echo $row->Fees; ?>
                    ...
                    <tr>
                      <th>Trainer Pic</th>
                      <td><img src="images/<?php echo $row->ProfilePics; ?>" width="100" height="100"
                          value="<?php echo $row->ProfilePics; ?>"></td>
                      <th>Course Duration</th>
                      <td>
                        <?php echo $row->ClassDuration; ?>
                      </td>
                    </tr>
