...
if (strlen($_SESSION['ycrsaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = "update tblclasses set DaysTime='" . $daystime . "',Description='" . $desc . "',YogaTrainer='" . $ytrainer . "'
    ,TrainerContactnumber='" . $tcnum . "',Fees='" . $fees . "',ClassDuration='" . $cd . "' 
     where ID='" . $eid . "' ";
    //print_r($sql);exit;
    ...
    foreach ($results as $row) { ?>
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <select class="form-control select2" style="width: 100%;" type="text" name="toc" required='true'
                        disabled="true">
                        <option value="<?php echo $row->TypeofClasses; ?>" selected="">
                          <?php echo $row->TypeofClasses; ?>
                        </option>
                    ...
                    <div class="form-group">
                      ...
                      <img src="images/<?php echo $row->YogaImages; ?>" width="100" height="100"
                        value="<?php echo $row->YogaImages; ?>">
                      <a href="changeimage.php?editid=<?php echo $row->ID; ?>"> &nbsp; Edit Image</a>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Days & Time</label>
                      <textarea class="form-control" name="daystime" id="exampleInputEmail1"
                        name="pagedes"><?php echo $row->DaysTime; ?></textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Description</label>
                      <textarea class="form-control" name="desc" id="exampleInputEmail1"
                        name="pagedes"><?php echo $row->Description; ?></textarea>
                    </div>
                    <div class="form-group">
                      <?php
      ...
      $results = $query->fetchAll(PDO::FETCH_OBJ);
                    ...
                    ?>
                      ...
                      <select type="text" class="form-control trn" name="ytrainer" value="<?php echo $row->YogaTrainer; ?>"
                        required='true'>
                        <option value="">Choose the Classes</option>
                        <?php foreach ($results as $datat) { ?>
                        <option value="<?php echo $datat->Tname; ?>" <?php if ($datat->Tname == $row->YogaTrainer) {
          echo "selected";
        } ?>>
                      ...
                      <input type="text" class="form-control" name="ytrainer" value="<?php echo $row->YogaTrainer; ?>"
                        required='true'> -->
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Trainer Contact Number</label>
                      <input type="text" class="form-control tcnum" name="tcnum"
                        value="<?php echo $row->TrainerContactnumber; ?>" required='true' maxlength="10"
                        pattern="[0-9]+">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="classduration"
                        value="<?php echo $row->ClassDuration; ?>" required='true'>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Trainer Profile Pics</label>
                      <!-- <img src="http://localhost/Yoga_Final/admin/images/<?php echo $row->ProfilePics; ?>" width="100" height="100"
                        value="<?php echo $row->ProfilePics; ?>"> -->
                      <img id="timage" height="100" width="100"  value="">  
