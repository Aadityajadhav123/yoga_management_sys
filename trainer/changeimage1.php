...
$sql="update tbltrainer set Timages=:img where ID=:eid";
...
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
 $query->execute();
   ...
   $query->execute();
    ...
    echo '<script>alert("Trainer Image has been updated")</script>';
...
{               ?>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input value="<?php  echo $row->Tname;?>" class="form-control" readonly='true'></option>
                  </div>
                  <div class="form-group">
