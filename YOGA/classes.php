...
<html lang="zxx">
<head>
	<title>Yoga Classes Registration System | Yoga Classes</title>
	...
	<div class="col-md-4">
							<div class="classes-item-warp">
								<div class="classes-item">
									<div class="ci-img">
										<img src="/Yoga_Final/admin/images/<?php echo $row->YogaImages;?>" alt="">
									</div>
									<div class="ci-text">
									...
									<div class="ci-bottom">
										<div class="ci-author">
											<img src="/Yoga_Final/admin/images/<?php echo $row->ProfilePics;?>" alt="">
