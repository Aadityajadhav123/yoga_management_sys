...
<head>
  ...
  <title>Yoga Classes Registration System | Dashboard</title>
...
?>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <?php 
                        $sql2 ="SELECT * from  tbltrainer ";
$query2 = $dbh -> prepare($sql2);
$query2 ->execute();
$results2=$query2 ->fetchAll(PDO::FETCH_OBJ);
$totaltrainer=$query2 ->rowCount();
?>
                <span class="info-box-text">Total Trainer</span>
                <span class="info-box-number"><?php echo htmlentities($totaltrainer);?></span>
                 <small><a href="manage-trainer.php"><b>View Detail</b></a></small>
              </div>
...
$totclasses=$query2->rowCount();?>
                ...
                <small><a href="manage-classes.php"><b><i class="fa fa-arrow-circle-right" style="color:black" aria-hidden="true"></i> &nbsp; View Detail</b></a></small>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <!-- <div class="row">
            <div class="col-md-12" style="display: inline-flex; padding: 0;"> -->
                <iframe height="300" style="width: 100%; height:800px; padding:30px ;" scrolling="no" title="#" src="graph/index.html" frameborder="no" allowtransparency="true" allowfullscreen="true"></iframe>
        <!-- </div>
                </div> -->
        </div>
        <!-- /.row -->
