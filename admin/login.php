...
<head>
    ...
    <style>
        .login-page {
           ...
           background-image:url('https://tympanus.net/Development/AnimatedHeaderBackgrounds/img/demo-2-bg.jpg');
            height: 261px;
...
<body class="demo-2" >
    <div class="hold-transition login-page large-header" id="large-header" >
        ...
        <p><a href="../index.php"><img src="yogaLogo.png" height="70" width="250"></a></p>
        <div class="login-box ">
           
            <div class="login-logo">
                <a href="login.php"><b>YCRS</b>Admin</a>
            </div>
            <!-- /.login-logo -->
            <div class="card">
                    ...
                    <form method="post">
                        ...
                        <div class="input-group mb-3">
                            <input type="password" class="form-control" name="password" required="true"
                                placeholder="Password" value="<?php if(isset($_COOKIE["
                                userpassword "])) { echo $_COOKIE[" userpassword "]; } ?>" onfocus="this.value = '';"
                            ...
                            <div class="col-8">
                                <div class="icheck-primary">
                                    <input type="checkbox" id="remember" name="remember" <?php
                                        if(isset($_COOKIE[ "user_login" ])) { ?> checked
                                    <?php } ?>>
                                    <label for="remember">
                                        Remember Me
                                    </label>
    ...
    <script src="dist/js/demo-2.js"></script>
