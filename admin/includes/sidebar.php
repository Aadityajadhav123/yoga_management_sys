  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard.php" class="brand-link">
      <img src="dist/img/logo.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">YCRS Admin</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="new_class.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create Class</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="action-classes.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Action Class</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <!-- <a href="trainer.php" class="nav-link"> -->
                <a href="trainer_1.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Trainer</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="manage-trainer.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Trainer</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            <a href="show_feedback.php" class="nav-link">
