...
{               ?>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input value="<?php  echo $row->YogaTrainer;?>" class="form-control" readonly='true'></option>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Old Trainer Images</label>
                   <img src="images/<?php echo $row->ProfilePics;?>" width="100" height="100" value="<?php  echo $row->ProfilePics;?>">

                  </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">New Trainer Images</label>
